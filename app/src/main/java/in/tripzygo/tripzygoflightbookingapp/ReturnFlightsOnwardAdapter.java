...
public class ReturnFlightsOnwardAdapter extends RecyclerView.Adapter<ReturnFlightsOnwardAdapter.ViewHolder> {
    ...
    public ReturnFlightsOnwardAdapter(List<FlightDetails> flightDetails, JsonArray RETURN, Context context, String type, FragmentManager fragmentManager, JsonObject paxInFo,JsonObject jsonObject) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        void bind(FlightDetails flightDetail) {
          ...
          /*  if (selectedItemIndex == -1) {
            ...
            DomesticReturnFareAdapter fareAdapter = new DomesticReturnFareAdapter(jsonObjects, context, flightDetail, fragmentManager, type, paxInFo,RETURN,jsonObject);
