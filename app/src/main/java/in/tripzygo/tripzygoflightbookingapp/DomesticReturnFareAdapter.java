...
import in.tripzygo.tripzygoflightbookingapp.Fragments.DomesticReturnFragment;
...
public class DomesticReturnFareAdapter extends RecyclerView.Adapter<DomesticReturnFareAdapter.ViewHolder> {
    List<JsonObject> jsonObjects;
    Context context;
    FlightDetails flightDetails;
    FragmentManager fragmentManager;
    String type;
    JsonObject paxInFo,js;
    JsonArray RETURN;



    public DomesticReturnFareAdapter(List<JsonObject> jsonObjects, Context context, FlightDetails flightDetails, FragmentManager fragmentManager, String type, JsonObject paxInFo, JsonArray RETURN,JsonObject jsonObject) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            fragmentManager.beginTransaction().replace(R.id.frame_return,new DomesticReturnFragment(paxInFo,type,id,fragmentManager,RETURN,flightDetails,js)).commit();
